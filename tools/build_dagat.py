...
PLATES: dict[str, str] = {
    ...
    "storm/shore_left.png": "stormy_seas/ChatGPT Image Sep 16, 2026, 06_49_11 PM (3).png",
    "storm/shore_right.png": "stormy_seas/ChatGPT Image Sep 16, 2026, 06_49_11 PM (4).png",
...
def build() -> dict:
    ...
    for owned in ("shore", "storm", "deep", "props", "ambience", "bakunawa", "reference"):
        directory = OUT / owned
        if directory.exists():
