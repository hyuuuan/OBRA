...
## One authored pixel is this many output pixels. Two reads unmistakably as pixel art at the
## size these rooms are drawn, without going so coarse that a doorway is four blocks wide.
PX = 2
SEED = 20260831

## Ordered dither. The classic 4x4 Bayer matrix, normalised: comparing a fractional blend
## against it is how a gradient is made out of two flat colours.
BAYER = np.array([
    [0, 8, 2, 10],
    [12, 4, 14, 6],
    [3, 11, 1, 9],
