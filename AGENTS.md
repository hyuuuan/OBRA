...
- **A level has two clocks.** Ink is level-scoped and priced by thesis FR-7: **six units,
  and one thing costs one unit.** A tool's CLASS costs a unit on its first successful
  recognition and redrawing it is free forever after (profile-wide, across levels and
  sessions) -- but the drawn tool itself is **used once** (Kent's call, overriding FR-7's
