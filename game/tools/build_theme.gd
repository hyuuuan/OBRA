...
## Generated by tools/build_font.py from the glyph table in tools/font_glyphs.py.
const FONT := "res://ui/obra_font.fnt"
...
func _initialize() -> void:
	...
	if font == null:
		push_error("no font at %s -- run tools/build_font.py" % FONT)
		quit(1)
		return
